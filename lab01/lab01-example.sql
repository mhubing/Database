...
Insert Into Book (ID, name, author, price) Values ('b15', "Software Engineering", 'Roger', 59);
...
insert into Borrow value('b8', 'r1', '2022-02-20', NULL);

insert into Borrow value('b15', 'r19', '2022-03-08', NULL);